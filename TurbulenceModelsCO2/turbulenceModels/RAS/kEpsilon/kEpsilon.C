...
//Info <<" alpha= "<< alpha << " rho= " << rho << " nut= " << nut << endl;

    eddyViscosity<RASModel<BasicTurbulenceModel>>::correct();

//Info<< "after eddyVisco correct"<<endl;
...
//Info<< "after epsilon updateCoeff"<<endl;
...
//Info<< "after epsilon equation"<<endl;
...
//Info<< "after k equation"<<endl;
    correctNut();
//Info<< "after correctNut"<<endl;
}
